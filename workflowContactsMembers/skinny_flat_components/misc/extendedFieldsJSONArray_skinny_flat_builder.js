...
consumableCodeArray.forEach(elementObject => {
    ...
    if(elementObject.action === 'BUILD'){
        ...
        // skinnyFlatElementObject.name = "HAPPY";//elementObject.displayName;
