...
// ø <MIGRATE original for this file>
import { contacts } from 'wix-crm-backend';

export function steamdaGetContactFunction() {
  const contactId = "bc0ae72b-3285-485b-b0ad-c32c769a4daf";
  const options = {
    suppressAuth: false
  };
...
// ø <DEPRECATED> crmModule.jsw
export function steamdaGetContactFunction(contactId) {
  //DEPRECATED? https://www.wix.com/velo/reference/wix-crm-backend/getcontactbyid
  const options = {
    suppressAuth: false
  };
